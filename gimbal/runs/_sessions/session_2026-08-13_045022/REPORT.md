...
- Status: **FAIL: step_outer_gimbal 실패로 중단. 이 테스트를 건너뛰고 계속하려면 --keep-going, 특정 테스트만 하려면 --tests 를 쓰세요.**
- Session: `session_2026-08-13_045022`
